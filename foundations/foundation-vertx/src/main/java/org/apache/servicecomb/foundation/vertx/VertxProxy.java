...
public class VertxProxy implements InvocationHandler {
  private AtomicLong eventLoopContextCreated = new AtomicLong();
  private Vertx vertx;

  public VertxProxy(Vertx vertx) {
    this.vertx = vertx;
  }
  ...
  public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
    if (method.getName().equals("createEventLoopContext")) {
      eventLoopContextCreated.incrementAndGet();
    }
    return method.invoke(vertx, args);
  }
